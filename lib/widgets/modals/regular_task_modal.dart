...
class RegularTaskModal extends StatefulWidget {
  ...
  RegularTaskModal(this.task, this.topPadding, this.onEditTap, this.onLockTap, this.onCopyTap);
  @override
                                      ...
                                      Container(
                                          ...
                                          child: Row(
                                              ...
                                              children: [
                                                GestureDetector(
                                                    onTapCancel: () {
                                                      setState(() => editButtonHold = false);
                                                    },
                                                    onTapUp: (d) {
                                                      setState(() => editButtonHold = false);
                                                    },
                                                    onTapDown: (d) {
                                                      setState(() => editButtonHold = true);
                                                    },
                                                    child: Material(
                                                ...
                                                GestureDetector(
                                                    onTapCancel: () {
                                                      setState(() => copyButtonHold = false);
                                                    },
                                                    onTapUp: (d) {
                                                      setState(() => copyButtonHold = false);
                                                    },
                                                    onTapDown: (d) {
                                                      setState(() => copyButtonHold = true);
                                                    },
                                                    child: Material(
                                                        animationDuration: Duration(milliseconds: 250),
                                                        color: Colors.white,
